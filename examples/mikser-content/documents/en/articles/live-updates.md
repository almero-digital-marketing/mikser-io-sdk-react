...
In the React SDK, `useDocument` and `useDocuments` wrap that primitive
in React state. Their callers (`ArticleIndex.jsx`, `ArticleView.jsx`,
etc.) write idiomatic React and get live updates for free.

To see it: open this article in any of the three React examples, then
