...
author: Alice Park
date: 2026-05-01
summary: First post — a tour of how this content set drives three different React example projects from the same catalog.
published: true
collection: articles
---
...
build tooling and entry point differ. The hooks, the dispatch, the
