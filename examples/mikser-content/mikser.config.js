...
//    so `useDocument` / `useDocuments` / `live()` work in the React apps
...
//  - cors is on by default so the React dev servers on different ports
...
export default {
    plugins: [
        ...
        layouts({
            ...
            // of meta.layout. The React apps do their own per-component
        ...
        schemas({
            ...
            onError: 'warn',
            // The generated declaration file is consumed by the example
            // projects — see e.g. hybrid-ssg/src/route-mapping.jsx for
            // how it's imported.
